...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ef7d1d503f281e1b0bc665da193fa2c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Anbu Huang"];
          homepage = Some "https://github.com/wong4ever/GI-LPV";
          synopsis =
            "Implement Global illumination with OCaml and GPU programming skill";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "vector";
                           InternalLibrary "bounding_box"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "SRC/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "vector"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "SRC/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [FindlibPackage ("GL", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["glex_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [FindlibPackage ("GL", None); InternalLibrary "glex"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("GL", None);
                           InternalLibrary "glex"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "SRC/";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "FBO"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "glex";
                           InternalLibrary "FBO";
                           InternalLibrary "texture";
                           InternalLibrary "depth_buffer"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "texture";
                           InternalLibrary "depth_buffer";
                           InternalLibrary "render_texture"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bigarray", None);
                           FindlibPackage ("GL", None);
                           FindlibPackage ("vertArray", None);
                           FindlibPackage ("VBO", None);
                           InternalLibrary "glex";
                           InternalLibrary "FBO";
                           InternalLibrary "vector";
                           InternalLibrary "bounding_box";
                           InternalLibrary "glsl_shader";
                           InternalLibrary "gl_buffer";
                           InternalLibrary "texture";
                           InternalLibrary "directional_light";
                           InternalLibrary "render_texture"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Depth_normal_buffer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "render_texture";
                           InternalLibrary "model";
                           InternalLibrary "depth_normal_buffer"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Indirect_light_buffer"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "render_texture";
                           InternalLibrary "directional_light";
                           InternalLibrary "geometry_volume"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bigarray", None);
                           FindlibPackage ("GL", None);
                           FindlibPackage ("Glu", None);
                           FindlibPackage ("Glut", None);
                           FindlibPackage ("vertArray", None);
                           FindlibPackage ("VBO", None);
                           InternalLibrary "glex";
                           InternalLibrary "FBO";
                           InternalLibrary "loadtga";
                           InternalLibrary "vector";
                           InternalLibrary "bounding_box";
                           InternalLibrary "glsl_shader";
                           InternalLibrary "gl_buffer";
                           ...
                           InternalLibrary "model";
                           InternalLibrary "depth_normal_buffer";
                           InternalLibrary "indirect_light_buffer";
                           InternalLibrary "geometry_volume";
                           InternalLibrary "grid";
                           InternalLibrary "camera"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
          ...
          plugins =
            [
               ...
               (`Extra, "DevFiles", Some "0.3) META (0.3")
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\147\255n\149\245\178\143~\199e\254$_8\148P";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
